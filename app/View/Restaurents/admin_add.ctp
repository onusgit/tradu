...
<div class="row">
	...
	<div class="portlet">
		...
		<?php echo $this->Form->create('Restaurent', array('id' => 'add_store', 'class' => 'form-horizontal'));?>
		<div class="row">
		    <div class="col-lg-12">
			<div class="col-sm-4">
			...
			<div class="col-sm-4 padding-0">
				...
				<div class="col-lg-9">
				    <?php echo $this->Form->input('address1', array('type' => 'text', 'class' => 'form-control required controls', 'label' => FALSE, 'id' => 'addr_id', 'div' => FALSE, 'placeholder' => '')); ?>
				</div>
			    </div>
			    <div class="form-group"><label class="col-lg-3 control-label"><?php echo __('Address'); ?></label>
				<div class="col-lg-9">
				    <?php echo $this->Form->input('address', array('class' => 'form-control', 'label' => FALSE, 'id' => 'route', 'rows' => '3', 'div' => FALSE, 'placeholder' => '')); ?>
				</div>
			    </div>
