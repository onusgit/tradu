...
"undefined" != typeof UserVoice && UserVoice.showLightbox || !function(t, e, o) {
    ...
    function r(e) {
        if ("getComputedStyle"in t) {
            for (var i = ["transitionDuration", "MozTransitionDuration", "WebkitTransitionDuration", "OTransitionDuration", "msTransitionDuration"], s = 0, n = 0, r = i.length; r > n; n++) {
                var a = i[n], l = N.getComputedStyle(e)[a] || e.style[a];
                if (l) {
                    s = 1e3 * parseFloat(l);
                    break
                }
            ...
            if (0 !== s) {
                var p = N.data(e, "transition-timer"), d = N.data(e, "transition-timeout-at"), c = +new Date + s;
                N.addClass(e, "uv-is-transitioning"), e.offsetWidth, (p === o || c > d) && (clearTimeout(p), N.data(e, "transition-timer", setTimeout(function() {
                    N.removeClass(e, "uv-is-transitioning"), e.offsetWidth
                }, s)), N.data(e, "transition-timeout-at", c))
            }
        }
    }
    function a(t) {
    ...
    function p() {
        if (!I) {
            var t = l(), e = /user-scalable\s*=\s*(0|1|no|yes)/;
            if (t) {
                A = t;
    ...
    function d() {
        if (I) {
            var t = l();
            t.parentNode.removeChild(t), A ? e.head.appendChild(A) : a("user-scalable=1"), I = !1
        }
    }
    function c(t, e) {
    ...
    function f() {
        Y || (b("#uvTab,.uv-tray,.uv-icon,.uv-popover,.uv-bubble{display:none!important}", "print"), Y = !0)
    }
    function v() {
        X || (b(".uv-icon:hover{opacity:1}"), X = !0)
    }
    function x() {
        return e.getElementsByTagName("html")[0]
    }
    function y() {
        var o = e.documentElement, i = o && o.clientWidth || e.body.clientWidth, s = t.innerHeight || o && o.clientHeight || e.body.clientHeight;
    ...
    function k(t, e) {
        return e && ("support" === e.mode ? e.post_idea_enabled = !1 : "feedback" === e.mode && (e.contact_enabled = !1), delete e.mode, e.default_mode !== o && (e.classic_default_mode = e.default_mode), _(e)), T({mode: t}, e || {})
    }
    function C() {
        C.fired || (C.fired = !0, K.tracker.trackExternalView(), K.tracker.ready(), K.scan())
    }
    var S = {};
    S.sanitizeValue = function(t, e) {
        ...
        var e, o, i, s, n, r, a, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", p = "", d = 0;
        for (t = S.uTF8Encode(t); d < t.length; )
            e = t.charCodeAt(d++), o = t.charCodeAt(d++), i = t.charCodeAt(d++), s = e >> 2, n = (3 & e) << 4 | o >> 4, r = (15 & o) << 2 | i >> 6, a = 63 & i, isNaN(o) ? r = a = 64 : isNaN(i) && (a = 64), p = p + l.charAt(s) + l.charAt(n) + l.charAt(r) + l.charAt(a);
        return p
    }, S.extend = function(t) {
        for (var e = Array.prototype.slice.call(arguments, 1), o = e.length, i = 0; o > i; i++)
            for (var s in e[i])
        ...
        i = S.extend({path: "/", domain: "", expires: new Date}, i || {});
        ...
        for (var o, i = (e.cookie || "").split(";"), s = i.length, n = 0; s > n; n++)
            if (o = S.trim(i[n]), o.substr(0, t.length + 1) === t + "=")
            ...
            switch (u && "object" == typeof u && "function" == typeof u.toJSON && (u = u.toJSON(t)), "function" == typeof r && (u = r.call(e, t, u)), typeof u) {
                ...
                case"object":
                    ...
                    if (s += n, c = [], "[object Array]" === Object.prototype.toString.apply(u)) {
                        for (d = u.length, a = 0; d > a; a += 1)
                            c[a] = i(a, u) || "null";
                        return p = 0 === c.length ? "[]" : s ? "[\n" + s + c.join(",\n" + s) + "\n" + h + "]" : "[" + c.join(",") + "]", s = h, p
                    }
                    if (r && "object" == typeof r)
                        for (d = r.length, a = 0; d > a; a += 1)
                            "string" == typeof r[a] && (l = r[a], p = i(l, u), p && c.push(o(l) + (s ? ": " : ":") + p));
                    else
                        for (l in u)
                            Object.prototype.hasOwnProperty.call(u, l) && (p = i(l, u), p && c.push(o(l) + (s ? ": " : ":") + p));
                    return p = 0 === c.length ? "{}" : s ? "{\n" + s + c.join(",\n" + s) + "\n" + h + "}" : "{" + c.join(",") + "}", s = h, p
                }
        }
        "object" != typeof JSON && (t.JSON = {}), "function" != typeof JSON.parse && (JSON.parse = function() {
            return{}
        ...
        var s, n, r, a = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, l = {"\b": "\\b", "	": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"};
        "function" != typeof JSON.stringify && (JSON.stringify = function(t, e, o) {
            ...
            if (s = "", n = "", "number" == typeof o)
                ...
                "string" == typeof o && (n = o);
            if (r = e, e && "function" != typeof e && ("object" != typeof e || "number" != typeof e.length))
    ...
    var z = function(t, o) {
        function i(e, o) {
            var s = this;
            this.subdomain = e, this.config = S.extend({}, i.default_config, o || {}), this.babaId = a++, this.sessionCallbackName = "__uvSessionData" + this.babaId, t[this.sessionCallbackName] = function(t) {
                s.sync(t)
            }, this.tracks = [], this.identity = null, this.session = null, this.uvts = null, this.isReady = !1, this.needsIdentityFlush = !1, this.needsSessionFlush = !1, this.firedUvts = !1, this.firedSession = !1, this.syncedSession = !0, this.cookieable = null, this.initFromCookie(), t.__babas.push(this)
        }
        function s(t) {
            this.props = {}, !t === Object(t) && (t = {}), this.set(S.extend({}, t, {o: (new Date).getTimezoneOffset()}))
        }
        function n() {
        ...
        t.__babas = t.__babas || [], i.prototype.initFromCookie = function() {
            ...
            this.log("Babayaga#updateSession: %O", t), this.needsSessionFlush = S.extend({}, this.needsSessionFlush || {}, this.session.set(t)), this.flush()
            ...
            this.log("Babayaga#sync: %O", t), t === Object(t) && (this.session.set(t), t.uvts && this.setUvts(t.uvts), this.syncCreatedAt(), this.fireSession())
        }, i.prototype.syncCreatedAt = function() {
            var t = this.identity && this.identity.get("created_at");
            t && (this.log("Babayaga#syncCreatedAt: %O", t), this.session.set({created_at: t}))
            ...
            this.uvts = t, S.setCookie(this.config.cookie_name, t, {domain: this.cookieDomain()}), this.firedUvts || ("function" == typeof this.config.onUvts && this.config.onUvts(t), this.firedUvts = !0)
        }, i.prototype.setConfig = function(t) {
            this.config = S.extend(this.config, t)
        }, i.prototype.setChannel = function(t) {
            this.setConfig({channel: t})
        }, i.prototype.track = function(t, e, o) {
            var i = {evt: t, props: e};
            o && (i.channel = o), this.tracks.push(i), this.flush()
        }, i.prototype.trackExternalView = function() {
            this.log("Babayaga#trackExternalView: %s", this.config.channel), "external" === this.config.channel && this.track("view_page", {u: e.location.toString(), r: e.referrer})
        }, i.prototype.flush = function() {
            if (this.isReady && this.config.enabled) {
                var t = 0, e = this.tracks.length;
                if (this.log("Babayaga#flush: %s", e), this.uvts || this.shouldTrack())
                    for ((0 === e && this.needsIdentityFlush || this.needsSessionFlush) && this.sendTrack({evt:"identify"}); e > t; t += 1)
                        this.sendTrack(this.tracks.shift())
            }
        }, i.prototype.sendTrack = function(t) {
            var o = [this.config.domain, "/t/", this.subdomain, "/", l[t.channel || this.config.channel] || "_", "/", p[t.evt] || "_"], i = {}, s = !this.syncedSession || !this.session.recurrent && !this.firedSession;
            ...
            this.log("Babayaga#ready: %s", this.isReady), this.isReady || (this.isReady = !0, this.session = new n, this.flush(), this.afterReady())
            ...
            return null === this.cookieable && (S.setCookie("__uvt", "1", {domain: this.cookieDomain()}), this.cookieable = !!S.getCookie("__uvt"), S.setCookie("__uvt", "", {domain: this.cookieDomain()})), this.log("Babayaga#haveCookies: %s", this.cookieable), this.cookieable
        }, i.prototype.log = function() {
            this.config.logging_enabled && S.log.apply(null, arguments)
        }, i.prototype.cookieDomain = function(e) {
            return this.cookie_domain ? this.cookie_domain : (e = e || t.location.hostname, e = e.split(".").slice(-2), e = e.length > 1 ? "." + e.join(".") : e.join("."), this.cookie_domain = e, e)
            ...
            for (o in t)
                s.keys.hasOwnProperty(o) && (this.props[o] = S.sanitizeValue(t[o], s.keys[o]));
            return this.props
        }, s.prototype.get = function(t) {
            return this.props[t]
        }, s.prototype.toJSON = function() {
            return this.props
        }, s.keys = {o: "int", name: "string", email: "string", id: "string", type: "string", created_at: "timestamp", account_name: "string", account_id: "string", account_monthly_rate: "float", account_ltv: "float", account_plan: "string", account_created_at: "timestamp"}, n.prototype.set = function(t) {
            var e, o = {};
            for (e in t)
                n.keys.hasOwnProperty(e) && (o[e] = S.sanitizeValue(t[e], n.keys[e]));
            for (e in o)
            ...
            var t, e = {};
            for (var i in n.keys)
                n.keys.hasOwnProperty(i) && (t = this.get(i), t !== o && (e[i] = t));
            return e
        }, n.prototype.isEnabled = function() {
            return this.store.isEnabled()
        }, n.keys = {created_at: "timestamp", last_sat_at: "timestamp", last_smartvote_at: "timestamp", dismissed_smartvote_at: "timestamp", dismissed_sat_at: "timestamp", autoprompted_satisfaction_at: "timestamp", autoprompted_smartvote_at: "timestamp", active_days: "int"}, r.prototype.isEnabled = function() {
            return!!this.storage
    ...
    }, V.match(/IEMobile/i) ? V.ieMobile = !0 : V.match(/msie (\d+\.\d+);/i) ? (V.ie = !0, V.version = parseInt(RegExp.$1, 10), V["ie" + V.version] = !0, V.ieCompatibility = 7 === V.version && V.match(/Trident/i), V.ieQuirks = e.compatMode && "BackCompat" === e.compatMode) : V.match(/Trident.*rv:(\d+)/i) && (V.ie = !0, V.version = parseInt(RegExp.$1, 10), V["ie" + V.version] = !0), V.touch = "ontouchstart"in t, V.mobile = V.match(/Android.*Mobile|iPhone|IEMobile/i), V.tablet = !V.mobile && V.match(/Android|iOS/i), V.iOS = "ontouchstart"in t && V.match(/like Mac OS X/i);
    var A, N = function() {
        var o = function() {
            var t, o, i;
            if (1 === arguments.length ? (t = e, o = "div", i = arguments[0]) : 2 === arguments.length ? (t = arguments[0], o = "div", i = arguments[1]) : (t = arguments[0], o = arguments[1], i = arguments[2]), t.querySelector)
        ...
        return o.uniqId = function() {
            ...
            var o = t.style, i = o.visibility, s = o.position, n = o.display;
            o.visibility = "hidden", o.position = "absolute", o.display = "block";
            var r = t.clientWidth, a = t.clientHeight;
            return o.display = n, o.position = s, o.visibility = i, {width: r, height: a}
        }, o.offset = function(t) {
            for (var e = t, o = {top: 0, left: 0}; e; )
                o.top += e.offsetTop, o.left += e.offsetLeft, e = e.offsetParent;
            return o
        }, o.on = function(e, o, i) {
            ...
            if (e.addEventListener)
                "complete" === e.readyState ? o() : (e.addEventListener("DOMContentLoaded", o, !1), t.addEventListener("load", o, !1));
        ...
        return t.prototype.push = function(t) {
            ...
            N.on(t, "load", function() {
                e.createElement(), e.show(), K.pendingAutoprompt && (K.pendingAutoprompt = !1, K.autoprompt())
            }), t.src = this.options.imgSrc, f()
        }, t.prototype.createElement = function() {
            var t = this.el = h(c(this.template, this.options)), e = t.getElementsByTagName("a")[0], o = this;
            N.addClass(t, "uv-tab uv-slide-" + this.edge), this.dimensions = N.dimensions(t), this.hide(!1), this.rotation && (t.style.marginTop = ["-", Math.round(this.dimensions.height / 2), "px"].join("")), N.on(e, "click", function(t) {
            ...
            t = t === o ? !0 : t, t && r(this.el), N.addClass(this.el, "uv-is-hidden"), this.el.offsetWidth
        }, t.prototype.show = function() {
            r(this.el), N.removeClass(this.el, "uv-is-hidden"), this.el.offsetWidth
        }, t.prototype.processOptions = function() {
            var t = {trigger_position: "right", trigger_background_color: "CC6D00", tab_label: "feedback", tab_inverted: !1}, e = T({}, t, this.options);
            ...
            var o = /([^\-]+)-([^\-]+)/.exec(e.trigger_position), i = o[1], s = o[2], n = "middle" === o[1] ? 90 : 0, r = UserVoice.account.white_labeled ? "-no-bullhorn" : "", a = ["tab-", e.inverted ? "light-" : "dark-", e.trigger_position].join(""), l = [n ? "link-vertical" : "link-horizontal", r].join(""), p = [M, "/dcache", "/widget/feedback-tab.png?t=", encodeURIComponent(e.tab_label), "&c=", e.tab_inverted ? encodeURIComponent(e.trigger_background_color) : "ffffff", "&r=", encodeURIComponent(n), e.tab_inverted ? "&i=yes" : ""].join(""), d = e.trigger_position.replace(/middle-/, "").replace(/(bottom|top)-(right|left)/, "horizontal");
            d = ["tab-", d, e.tab_inverted ? "-light" : "-dark", r].join(""), d = [M, UserVoice.manifest[d]].join(""), e.bgImage = d, e.imgSrc = p, e.tab_label = u(e.tab_label), a = j[a], l = j[l], (V.ie6 || V.ieQuirks) && (a += "position:absolute !important;", "top" === i ? a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (!this.offsetHeight && 0)) + 'px');" : "middle" === i ? a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + ((((document.documentElement.clientHeight || document.body.clientHeight) + (!this.offsetHeight && 0)) / 2) >> 0)) + 'px');" : "bottom" === i && (a += "top: expression(((document.documentElement.scrollTop || document.body.scrollTop) + (document.documentElement.clientHeight || document.body.clientHeight) - this.offsetHeight) + 'px');")), e.tabStyle = c(a, {color: e.trigger_background_color, bgImage: e.bgImage}), e.linkStyle = l, "top" === i ? this.edge = "top" : "bottom" === i ? this.edge = "bottom" : "left" === s ? this.edge = "left" : "right" === s && (this.edge = "right"), this.rotation = n, this.options = e
        }, t
    }(), W = function() {
        function i() {
        }
        return i.template = '      <div class="uv-popover-content">        <div class="uv-popover-iframe-container"></div>        <div class="uv-popover-loading"><div class="uv-popover-loading-text">Loading&#8230;</div></div>        <!-- shadow for ie8 -->        <div class="uv-popover-content-shadow"></div>      </div>    ', i.prototype.show = function(t) {
            t = t === o ? !0 : t, K.hideActive(), K.active = this, this.el || this.render(), this.trigger && (this.trigger.visibleWidget = this), this.trigger && this.trigger.popoverWillShow && this.trigger.popoverWillShow(), t ? this.animateIn() : N.removeClass(this.el, "uv-is-hidden"), this.iframe.poke({show: !0}), this.iframe.poke({focus: null})
        }, i.prototype.hide = function(t) {
            if (t = t === o ? !0 : t, K.active = null, this.el || this.render(), this.trigger && (this.trigger.visibleWidget = null), this.trigger && this.trigger.popoverWillHide && this.trigger.popoverWillHide(), t ? this.animateOut() : N.addClass(this.el, "uv-is-hidden"), this.temp) {
                var e = this.el;
                setTimeout(function() {
            ...
            this.position(), r(this.el), N.removeClass(this.el, "uv-is-hidden"), this.el.offsetWidth, this.createIframe()
        }, i.prototype.preload = function() {
            this.el || this.render(), this.createIframe(!0)
        }, i.prototype.animateOut = function() {
            r(this.el), N.addClass(this.el, "uv-is-hidden")
        }, i.prototype.visible = function() {
            return!N.hasClass(this.el, "uv-is-hidden") && !this.preloading
        }, i.prototype.paneOpened = function(t, e) {
            e.needsReload && (this.needsReload = !0)
        }, i.prototype.position = function() {
            this.preloading && (N.addClass(this.el, "uv-is-hidden"), this.el.style.left = "", this.preloading = !1);
            var t = this.visible();
            N.addClass(this.el, "uv-no-transition"), t || (N.addClass(this.el, "uv-is-invisible"), this.el.style.left = "-1000px"), N.removeClass(this.el, "uv-scale-\\S+"), this.el.offsetWidth, this.calculatePosition(), this.el.offsetWidth, t || N.removeClass(this.el, "uv-is-invisible"), N.removeClass(this.el, "uv-no-transition"), this.el.offsetWidth
        }, i.prototype.createIframe = function(e) {
            var o = N(this.el, "uv-popover-iframe-container"), i = N(this.el, "uv-popover-loading"), s = this;
            (!this.iframe || this.needsReload) && (this.iframe && (o.removeChild(this.iframe.el), this.needsReload = !1), e && (N.removeClass(this.el, "uv-is-hidden"), this.el.style.left = "-10000px", this.preloading = !0), this.iframe = new H("popover", this.options.widgetType, T({height: "100%"}, UserVoice.globalOptions, this.options)), this.iframe.render(), N.addClass(this.iframe.el, "uv-popover-iframe"), o.appendChild(this.iframe.el), V.ie8 && N.addClass(this.el, "uv-ie8"), N.on(t, "resize", function() {
                s.visible() && s.calculatePosition()
            }), i && i.parentNode && (this.iframe.loaded || V.ie && V.version < 10 ? i.parentNode.removeChild(i) : N.one(this.iframe.el, "load", function() {
                s.preloading && (N.addClass(s.el, "uv-is-hidden"), s.el.style.left = "", s.preloading = !1), i.parentNode.removeChild(i)
            })))
        }, i.prototype.createElement = function(t) {
            var o = this.el = e.createElement("div");
            o.innerHTML = this.template, o.setAttribute("data-html2canvas-ignore", !0), this.options.width && !V.mobile && (N(o, "uv-popover-content").style.width = this.options.width), this.options.height && !V.mobile && (N(o, "uv-popover-content").style.height = this.options.height), N.addClass(this.el, "uv-popover uv-is-hidden"), t.appendChild(o)
        }, i
    }(), D = function() {
        function o(t) {
        ...
        return o.prototype = T({}, W.prototype), o.prototype.render = function() {
            ...
            if (V.mobile && p(), W.prototype.show.apply(this, arguments), V.mobile) {
                var e = this;
                this.sizeForMobile(), this.resizeForMobile = function() {
                    e.sizeForMobile()
                }, N.on(t, "scroll", this.resizeForMobile)
            }
        }, o.prototype.hide = function() {
            W.prototype.hide.apply(this, arguments), V.mobile && (d(), N.off(t, "scroll", this.resizeForMobile), this.needsReload = !0)
        }, o.prototype.sizeForMobile = function() {
            var t = this;
            setTimeout(function() {
                var e = N(t.el, "uv-popover-content"), o = N(e, "uv-popover-iframe-container"), i = N(o, "iframe", "uv-popover-iframe"), s = t.el.offsetHeight, n = t.el.offsetWidth;
                e.style.height = s + "px", o.style.height = s + "px", i.style.height = s + "px", e.style.width = n + "px", o.style.width = n + "px", i.style.width = n + "px"
            }, 200)
        }, o.prototype.calculatePosition = function() {
            var e = this.options.position.match(/^(top|bottom)-(left|right)$/) ? this.options.position : "bottom-right", o = /(\w+)-(\w+)/.exec(e);
            if (this.el.style.zIndex = 100003, V.mobile) {
                var i = N(this.el, "uv-popover-content"), s = t.innerWidth, n = 325, r = 10, a = s / (n + 2 * r), l = Math.round(a * r);
            ...
            N.addClass(this.el, "uv-" + ("bottom" === o[1] ? "top" : "bottom")), N.addClass(this.el, "uv-scale-" + e)
        }, o
    }(), B = function() {
        function t(t, e) {
        ...
        return t.prototype = T({}, W.prototype), t.prototype.render = function() {
            this.target = "self" === this.options.target ? this.trigger.el : N.element(this.options.target), K.systemTrigger && this.target === K.systemTrigger.el ? (this.container = this.target, this.isContained = !0) : this.container = e.body, this.createElement(this.container)
            ...
            var t = this.target, o = N.offset(t), i = N.dimensions(t), s = t.currentStyle ? t.currentStyle.position : N.getComputedStyle(t, null).position, n = 100;
        ...
        return t.icon_images = {contact: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\r\n	 width="39px" height="39px" viewBox="0 0 39 39" enable-background="new 0 0 39 39" xml:space="preserve">\r\n<g>\r\n	<path class="uv-bubble-background" fill="rgba(46, 49, 51, 0.6)" d="M31.425,34.514c-0.432-0.944-0.579-2.007-0.591-2.999c4.264-3.133,7.008-7.969,7.008-13.409\r\n		C37.842,8.658,29.594,1,19.421,1S1,8.658,1,18.105c0,9.446,7.932,16.79,18.105,16.79c1.845,0,3.94,0.057,5.62-0.412\r\n		c0.979,1.023,2.243,2.3,2.915,2.791c3.785,2.759,7.571,0,7.571,0S32.687,37.274,31.425,34.514z"/>\r\n	<g>\r\n		<g>\r\n			<path class="uv-bubble-foreground" fill="#FFFFFF" d="M16.943,19.467c0-3.557,4.432-3.978,4.432-6.058c0-0.935-0.723-1.721-2.383-1.721\r\n				c-1.508,0-2.773,0.725-3.709,1.87l-2.441-2.743c1.598-1.9,4.01-2.924,6.602-2.924c3.891,0,6.271,1.959,6.271,4.765\r\n				c0,4.4-5.037,4.732-5.037,7.265c0,0.481,0.243,0.994,0.574,1.266l-3.316,0.965C17.303,21.459,16.943,20.522,16.943,19.467z\r\n				 M16.943,26.19c0-1.326,1.114-2.441,2.44-2.441c1.327,0,2.442,1.115,2.442,2.441c0,1.327-1.115,2.441-2.442,2.441\r\n				C18.058,28.632,16.943,27.518,16.943,26.19z"/>\r\n		</g>\r\n	</g>\r\n</g>\r\n</svg>\r\n', feedback: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\n	 width="39px" height="39px" viewBox="0 0 39 39" enable-background="new 0 0 39 39" xml:space="preserve">\n<g>\n	<path class="uv-bubble-background" fill="rgba(46, 49, 51, 0.6)"  d="M31.425,34.514c-0.432-0.944-0.579-2.007-0.591-2.999c4.264-3.133,7.008-7.969,7.008-13.409\n		C37.842,8.658,29.594,1,19.421,1S1,8.658,1,18.105c0,9.446,7.932,16.79,18.105,16.79c1.845,0,3.94,0.057,5.62-0.412\n		c0.979,1.023,2.243,2.3,2.915,2.791c3.785,2.759,7.571,0,7.571,0S32.687,37.274,31.425,34.514z"/>\n</g>\n<g>\n	<g>\n		<path class="uv-bubble-foreground" fill="#FFFFFF" d="M24.951,9.07c-0.83-0.836-1.857-1.453-2.976-1.786C21.337,7.096,20.672,7,20,7\n			c-1.87,0-3.628,0.736-4.952,2.07C13.728,10.403,13,11.864,13,13.751l0.03,0.648c0.086,0.972,0.368,1.896,0.834,2.752\n			c0.776,1.399,2.367,2.849,2.637,4.993l0.163,0.972C16.809,23.703,17.105,24,17.549,24h5.054c0.445,0,0.742-0.297,0.884-0.884\n			l0.014-0.972c0.268-2.144,1.802-3.593,2.657-4.993c0.443-0.855,0.725-1.779,0.811-2.752L27,13.751\n			C26.999,11.864,26.271,10.405,24.951,9.07z M17.101,26.554h5.741v-1.66h-5.741V26.554z M18.392,28.668h3.216l0.414-0.83h-4.101\n			L18.392,28.668z"/>\n	</g>\n</g>\n</svg>\n', post_idea: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\n	 width="39px" height="39px" viewBox="0 0 39 39" enable-background="new 0 0 39 39" xml:space="preserve">\n<g>\n	<path class="uv-bubble-background" fill="rgba(46, 49, 51, 0.6)"  d="M31.425,34.514c-0.432-0.944-0.579-2.007-0.591-2.999c4.264-3.133,7.008-7.969,7.008-13.409\n		C37.842,8.658,29.594,1,19.421,1S1,8.658,1,18.105c0,9.446,7.932,16.79,18.105,16.79c1.845,0,3.94,0.057,5.62-0.412\n		c0.979,1.023,2.243,2.3,2.915,2.791c3.785,2.759,7.571,0,7.571,0S32.687,37.274,31.425,34.514z"/>\n</g>\n<g>\n	<g>\n		<path class="uv-bubble-foreground" fill="#FFFFFF" d="M24.951,9.07c-0.83-0.836-1.857-1.453-2.976-1.786C21.337,7.096,20.672,7,20,7\n			c-1.87,0-3.628,0.736-4.952,2.07C13.728,10.403,13,11.864,13,13.751l0.03,0.648c0.086,0.972,0.368,1.896,0.834,2.752\n			c0.776,1.399,2.367,2.849,2.637,4.993l0.163,0.972C16.809,23.703,17.105,24,17.549,24h5.054c0.445,0,0.742-0.297,0.884-0.884\n			l0.014-0.972c0.268-2.144,1.802-3.593,2.657-4.993c0.443-0.855,0.725-1.779,0.811-2.752L27,13.751\n			C26.999,11.864,26.271,10.405,24.951,9.07z M17.101,26.554h5.741v-1.66h-5.741V26.554z M18.392,28.668h3.216l0.414-0.83h-4.101\n			L18.392,28.668z"/>\n	</g>\n</g>\n</svg>\n', smartvote: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\n	 width="39px" height="39px" viewBox="0 0 39 39" enable-background="new 0 0 39 39" xml:space="preserve">\n<g>\n	<path class="uv-bubble-background" fill="rgba(46, 49, 51, 0.6)"  d="M31.425,34.514c-0.432-0.944-0.579-2.007-0.591-2.999c4.264-3.133,7.008-7.969,7.008-13.409\n		C37.842,8.658,29.594,1,19.421,1S1,8.658,1,18.105c0,9.446,7.932,16.79,18.105,16.79c1.845,0,3.94,0.057,5.62-0.412\n		c0.979,1.023,2.243,2.3,2.915,2.791c3.785,2.759,7.571,0,7.571,0S32.687,37.274,31.425,34.514z"/>\n</g>\n<g>\n	<g>\n		<path class="uv-bubble-foreground" fill="#FFFFFF" d="M24.951,9.07c-0.83-0.836-1.857-1.453-2.976-1.786C21.337,7.096,20.672,7,20,7\n			c-1.87,0-3.628,0.736-4.952,2.07C13.728,10.403,13,11.864,13,13.751l0.03,0.648c0.086,0.972,0.368,1.896,0.834,2.752\n			c0.776,1.399,2.367,2.849,2.637,4.993l0.163,0.972C16.809,23.703,17.105,24,17.549,24h5.054c0.445,0,0.742-0.297,0.884-0.884\n			l0.014-0.972c0.268-2.144,1.802-3.593,2.657-4.993c0.443-0.855,0.725-1.779,0.811-2.752L27,13.751\n			C26.999,11.864,26.271,10.405,24.951,9.07z M17.101,26.554h5.741v-1.66h-5.741V26.554z M18.392,28.668h3.216l0.414-0.83h-4.101\n			L18.392,28.668z"/>\n	</g>\n</g>\n</svg>\n', satisfaction: '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\r\n	 width="39px" height="39px" viewBox="0 0 39 39" enable-background="new 0 0 39 39" xml:space="preserve">\r\n<g>\r\n	<path class="uv-bubble-background" fill="rgba(46, 49, 51, 0.6)" d="M31.425,34.514c-0.432-0.944-0.579-2.007-0.591-2.999c4.264-3.133,7.008-7.969,7.008-13.409\r\n		C37.842,8.658,29.594,1,19.421,1S1,8.658,1,18.105c0,9.446,7.932,16.79,18.105,16.79c1.845,0,3.94,0.057,5.62-0.412\r\n		c0.979,1.023,2.243,2.3,2.915,2.791c3.785,2.759,7.571,0,7.571,0S32.687,37.274,31.425,34.514z"/>\r\n</g>\r\n<g>\r\n	<g>\r\n		<path class="uv-bubble-foreground" fill="#FFFFFF" d="M13.501,19.25c0.308,0.3,0.501,0.891,0.427,1.314l-1.02,5.95c-0.073,0.423,0.18,0.604,0.56,0.404\r\n			l5.338-2.806c0.381-0.2,1.004-0.2,1.385,0l5.338,2.806c0.38,0.201,0.633,0.018,0.561-0.404l-1.02-5.95\r\n			C25,20.141,25.191,19.55,25.499,19.25l4.321-4.21c0.308-0.3,0.211-0.596-0.215-0.658l-5.968-0.868\r\n			c-0.426-0.062-0.93-0.427-1.119-0.813l-2.673-5.412c-0.19-0.385-0.501-0.385-0.691,0l-2.671,5.412\r\n			c-0.191,0.385-0.695,0.75-1.12,0.813l-5.967,0.868c-0.426,0.062-0.523,0.358-0.215,0.658L13.501,19.25z"/>\r\n	</g>\r\n</g>\r\n</svg>\r\n'}, t.icon_images_ie8 = {contact: "//widget.uservoice.com/omnibox/icons/question_mark_bubble_icon.png", feedback: "//widget.uservoice.com/omnibox/icons/lightbulb_bubble_icon.png", post_idea: "//widget.uservoice.com/omnibox/icons/lightbulb_bubble_icon.png", smartvote: "//widget.uservoice.com/omnibox/icons/lightbulb_bubble_icon.png", satisfaction: "//widget.uservoice.com/omnibox/icons/star_bubble_icon.png"}, t.prototype.remove = function() {
            ...
            var e = this, o = "classic_widget" === this.widget.options.mode ? "contact" : this.widget.options.mode;
            ...
            this.el.innerHTML = i, V.ie8 || (this.options.trigger_color && (N(this.el, "path", "uv-bubble-foreground").style.fill = this.options.trigger_color), this.options.trigger_background_color && (N(this.el, "path", "uv-bubble-background").style.fill = this.options.trigger_background_color)), N.on(this.el, "click", function() {
                e.visibleWidget ? e.visibleWidget.hide() : e.widget.show()
            }), V.touch || V.ie && !(V.ie && V.version > 9) || N.one(e.el, "mousemove", function() {
                e.widget.preload()
            })
        }, t.prototype.createElement = function() {
            var t = this.el = e.createElement("div");
            t.setAttribute("data-html2canvas-ignore", !0), N.addClass(this.el, "uv-icon uv-" + this.options.trigger_position), V.ie8 && N.addClass(this.el, "uv-ie8"), e.body.appendChild(this.el)
        }, t.prototype.popoverWillShow = function() {
            N.addClass(this.el, "uv-is-selected")
        }, t.prototype.popoverWillHide = function() {
            N.removeClass(this.el, "uv-is-selected")
        }, t
    }(), J = function() {
        function t(t, e) {
            this.el = t, this.options = e, N.data(this.el, "trigger", this)
        }
        return t.prototype.render = function() {
            ...
            }, N.on(this.el, "click", this.clickHandler), V.touch || V.ie && !(V.ie && V.version > 9) || N.one(this.el, "mousemove", function() {
                t.removed || t.widget.preload()
            })
        }, t.prototype.remove = function() {
            this.removed = !0, N.off(this.el, "click", this.clickHandler)
        }, t
    }(), H = function() {
        function i(t, e, o) {
            this.options = T({css: "display: block; background: transparent; padding: none; margin: none; border: none; width: #{width}; height: #{height}", cdn: "omnibox" === e, embed_type: t, type: e, width: "100%", height: "100%"}, o), this.options.mode.match(/contact|instant/) ? this.options.mode = "contact" : "post_idea" === this.options.mode ? this.options.mode = "feedback" : "satisfaction" === this.options.mode && (this.options.survey_lockout = !1), this.pokes = [], this.loaded = !1, this.setLocation(), this.src = [this.location.baseUrl, this.queryString()].join("?"), this.sendUvtsAndEmail(), i.all.push(this)
        }
        return i.all = [], i.prototype.setLocation = function() {
            var t = "https";
            if (this.options.cdn) {
                var e = "widget.uservoice.com";
                this.location = {host: e, protocol: t, baseUrl: t + "://" + e + "/" + this.options.type + "/" + UserVoice.account.client_key}
            } else
                this.location = {host: UserVoice.account.subdomain_ssl_host, protocol: t, baseUrl: t + "://" + UserVoice.account.subdomain_ssl_host + "/clients/widgets/" + this.options.type};
            ...
            var t = this.el = e.createElement("iframe"), o = this, i = {height: this.options.height, width: this.options.width}, s = c(this.options.css, i);
            if (t.attachEvent ? t.attachEvent("onload", function() {
                o.doLoad()
            }) : t.onload = function() {
                o.doLoad()
            }, t.name = "uvw-iframe-" + this.options.id, N.addClass(t, "uvw-dialog-iframe"), V.ie ? t.style.setAttribute("cssText", s, 0) : t.setAttribute("style", s), t.setAttribute("allowtransparency", "true"), t.setAttribute("frameBorder", "0"), t.frameBorder = 0, !(V.ie && V.version < 9)) {
            ...
            return a && "object" == typeof a && (e.custom_fields = U(JSON.stringify(a))), e.smartvote_status_ids && (e.status_ids = e.smartvote_status_ids, delete e.smartvote_status_ids), e.smartvote_category_ids && (e.category_ids = e.smartvote_category_ids, delete e.smartvote_category_ids), this.options.menu_enabled !== o && (e.menu = this.options.menu_enabled), this.options.smartvote_enabled !== o && (e.smartvote = this.options.smartvote_enabled), this.options.satisfaction_enabled !== o && (e.satisfaction = this.options.satisfaction_enabled), this.options.post_idea_enabled !== o && (e.feedback_enabled = this.options.post_idea_enabled), "classic_widget" === this.options.type && (this.options.classic_default_mode !== o && (e.default_mode = this.options.classic_default_mode), e.mode = this.options.contact_enabled ? this.options.post_idea_enabled ? "full" : "support" : "feedback"), e.referrer = t.location.href, g(e, function(t) {
                try {
        ...
        return o.prototype.toggle = function() {
            ...
            if (this.overlay || (b(P), this.overlay = h(c(this.template, this))), this.iframe.poke("opened"), !this.dialog || this.dialog.getAttribute("data-widget-key") !== this.id) {
                ...
                var t = this;
                N.on(e.getElementById(this.dialog_close_id), "click", function() {
                    return t.hide()
                })
            }
        }, o
    }(), K = function() {
        var i = {session: !1, syncedSession: !1};
        return i.setUvts = function(t) {
            i.uvts = t, H.sendUvtsAndEmail()
        }, i.setEmail = function(t) {
            i.email = t, H.sendUvtsAndEmail()
        ...
        }, i.tracker = new z(UserVoice.account.subdomain_id, {channel: e.location.host === UserVoice.account.subdomain_site_host ? "site2" : "external", onUvts: i.setUvts, onSession: i.setSession, onSync: i.syncSession}), i.autoprompt = function() {
            if (this.session === !1 || this.systemTrigger && this.systemTrigger.el === o)
                return this.pendingAutoprompt = !0, void 0;
            var t = this.tracker.dumpSession(), e = this.shouldShowSatisfactionPrompt(t), s = this.shouldShowSmartVotePrompt(t);
            if (e || s) {
                if (this.syncedSession === !1)
                    return this.pendingAutoprompt = !0, this.tracker.syncSession(), void 0;
                e && (this.tracker.updateSession({dismissed_sat_at: (new Date).getTime()}), i.pushSystemWidget({mode: "satisfaction"}), i.showAutoprompt({mode: "satisfaction"}), this.tracker.track("autoprompt", {}, "satisfaction_widget")), s && (this.tracker.updateSession({dismissed_smartvote_at: (new Date).getTime()}), i.showAutoprompt({mode: "smartvote"}), this.tracker.track("autoprompt", {}, "smartvote_widget"))
            }
        }, i.shouldShowSatisfactionPrompt = function(t) {
            if (!UserVoice.account.satisfaction_autoprompt_enabled)
                return!1;
            var e = ((new Date).getTime(), Math.max(t.created_at || 0, this.lastSatisfactionPrompt(t))), o = this.lastSmartvotePrompt(t);
            return 0 !== e ? w(e) >= 60 && (0 === o || w(o) >= 21) : !1
        }, i.shouldShowSmartVotePrompt = function(t) {
            if (!UserVoice.account.smartvote_autoprompt_enabled)
                return!1;
            var e = ((new Date).getTime(), this.lastSmartvotePrompt(t)), o = this.lastSatisfactionPrompt(t);
            ...
            "classic_widget" === e ? new $(t, k(e, o)) : new $(t, T({mode: e, contact_enabled: !0, post_idea_enabled: !0, smartvote_enabled: !0, feedback_enabled: !0}, o))
        }, i.linkToLightbox = function(t, e, o) {
            i.createCustomTrigger(t, T({target: "lightbox"}, k(e, o)))
        }, i.linkToPopover = function(t, e, o) {
            i.createCustomTrigger(t, T({mode: e}, o))
        }, i.extractOptions = function(t) {
            for (var e = {}, o = 0; o < t.attributes.length; o++) {
                var i = t.attributes[o], s = i.value;
            ...
            var o = new J(t, T({trigger_prevent_default_enabled: !0}, UserVoice.globalOptions, e)), s = i.createWidget(T({trigger_method: "custom_trigger"}, e), o);
            return e && e.autoprompt && (i.autopromptOptions = T({target: t}, Widget.autopromptOptions || {})), o.widget = s, o.render(), o
        }, i.createSystemTrigger = function(t) {
            var e = T({trigger_color: "white"}, UserVoice.globalOptions, t || {}), o = e.trigger_style || "icon", s = "icon" === o ? new R(e) : new L(e), n = i.createWidget(T({trigger_method: "pin"}, t), s);
            if (!(V.ie && V.version < 8 && "icon" === o))
                return s.push(n), s.render(), s
        }, i.createWidget = function(t, e) {
            var o = {target: "self", contact_enabled: !0, post_idea_enabled: !0, smartvote_enabled: !0, feedback_enabled: !0}, s = i.processModeOptions(T(o, UserVoice.globalOptions, t));
            return V.mobile && (s.mobile = !0), "lightbox" === s.target || "classic_widget" === s.mode ? new q(s, e) : s.target === !1 || "self" === s.target && !e ? (s.position = s.position || "bottom-right", new D(s, e)) : (s.position && s.position.match(/^(automatic|top|bottom|left|right)$/) || (s.position = "automatic"), V.mobile ? new D(s, e) : new B(s, e))
        }, i.showWidget = function(t) {
            i.createWidget(T({temp: !0}, t), i.systemTrigger).show()
        }, i.showAutoprompt = function(t) {
            i.recordAutoprompt(t.mode), i.showWidget(T({trigger_method: "autoprompt"}, i.autopromptOptions || {}, t))
            ...
            var o = i.tracker.getIdentity() || {}, s = {"audit[prompt_type]": t, "audit[uvts]": i.uvts, "audit[session_data]": JSON.stringify(i.tracker.dumpSession()), "audit[external_user_id]": o.id, "audit[email]": o.email}, n = e.getElementsByTagName("script")[0], r = e.createElement("script");
            r.type = "application/javascript", r.async = !0, r.defer = !0, r.src = "http://" + UserVoice.account.subdomain_ssl_host + "/clients/widgets/omnibox/autoprompts/create.json?" + g(s), n.parentNode.insertBefore(r, n)
        }, i.includeCss = function() {
            b(E)
        }, new F({openPane: function(t) {
                ...
                i.tracker.updateSession({last_smartvote_at: (new Date).getTime()})
            }, ratingSubmitted: function() {
                i.systemTrigger && i.systemTrigger.pop(), i.tracker.updateSession({last_sat_at: (new Date).getTime()})
            }, captureScreenshot: function(o, i, s) {
                ("http://widget.uservoice.com" === s || "https://widget.uservoice.com" === s) && (t.html2canvas_onload_options = {onrendered: function(t) {
                        var e = t.toDataURL("image/png");
                        if (e) {
                            var n = e.split(",", 2)[1];
                            i.postMessage(JSON.stringify({identifier: o, content_type: "image/png", base64data: n, width: t.width, height: t.height}), s)
                        }
                    }}, function() {
    ...
    UserVoice.globalOptions = {}, UserVoice.push = function(t) {
        ...
        return("string" != typeof t || "#" === t[0]) && (e = arguments[0], s = arguments[1], t = null), e === o ? i("please specify where to embed it.") : (K.renderInline(N.element(e), t, s), void 0)
    }, UserVoice.addTrigger = function(t, e) {
        if (t && t.nodeName || "string" == typeof t) {
            if (V.ie && V.version < 8)
                return;
            K.createCustomTrigger(N.element(t), e)
        } else
            e = t || {}, K.systemTrigger && K.systemTrigger.remove(), K.systemTrigger = K.createSystemTrigger(_(e))
    }, UserVoice.show = function(t) {
        "string" == typeof arguments[0] && (t = T({mode: arguments[0]}, arguments[1] || {})), K.showWidget(T({trigger_method: "show"}, t || {}))
    }, UserVoice.hide = function() {
        K.hideActive()
    }, UserVoice.removeTrigger = function(t) {
        t ? N.data(N.element(t), "trigger").remove() : (K.systemTrigger.remove(), K.systemTrigger = null)
    }, UserVoice.autoprompt = function(t) {
        K.autopromptOptions = t, K.autoprompt()
    }, UserVoice.identify = function(t) {
        K.tracker.identify(t), t && t.email && K.setEmail(t.email)
    }, UserVoice.track = function(t, e) {
        K.tracker.track(t, e)
    }, UserVoice.footprint = function(t) {
        K.tracker.setConfig({enabled: t})
        ...
        K.showWidget(T({target: "lightbox"}, k(t, e)))
    }, UserVoice.hideLightbox = function() {
    }, UserVoice.showIcon = UserVoice.pin = function(t, e) {
        e && (e.trigger_position = e.position, e.position = "automatic"), UserVoice.addTrigger(T({mode: t, trigger_style: "icon"}, e || {}))
    }, UserVoice.showTab = function(t, e) {
        UserVoice.addTrigger(T({trigger_style: "tab"}, k(t, e)))
    }, K.includeCss();
    for (var Q = 0; Q < UserVoice.events.length; Q++)
        UserVoice.push(UserVoice.events[Q]);
    K.scan(), N.ready(C)
}(window, document);